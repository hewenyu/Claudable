...
def push_to_remote(
    repo_path: str, remote_name: str = "origin", branch: str = "main"
) -> dict:
    ...
    try:
        ...
        try:
            ...
            result = _run(
                ["git", "push", "-u", "--force", remote_name, branch], cwd=repo_path
            )
...
def commit_all(repo_path: str, message: str) -> dict:
    ...
    try:
        ...
        return {"success": True, "commit_hash": commit_sha, "message": message}
    except subprocess.CalledProcessError as e:
