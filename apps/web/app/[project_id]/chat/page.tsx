    ...
    <>
      ...
      <div className="h-screen bg-white dark:bg-black flex relative overflow-hidden">
        <div className="h-full w-full flex">
          {/* 왼쪽: 파일 관리 & Git (VSCode 스타일) */}
          <div className="w-64 flex-shrink-0 bg-gray-50 dark:bg-[#0a0a0a] border-r border-gray-200 dark:border-[#1a1a1a] flex flex-col">
            {/* 프로젝트 헤더 */}
            <div className="bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 p-3 h-[73px] flex items-center">
              <div className="flex items-center gap-3 w-full">
                <button 
                  onClick={() => router.push('/')}
                  className="flex items-center justify-center w-6 h-6 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors"
                  title="Back to home"
                >
                ...
                <div className="flex-1 min-w-0">
                  <h1 className="text-sm font-semibold text-gray-900 dark:text-white truncate">{projectName || 'Loading...'}</h1>
                  {/* Git Branch Selector for Workspaces */}
                  {isWorkspace && currentBranch && (
                    <div className="mt-1 relative" data-branch-dropdown>
                      <button
                        onClick={() => setShowBranchDropdown(!showBranchDropdown)}
                        disabled={switchingBranch}
                        className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 rounded hover:bg-blue-200 dark:hover:bg-blue-900/40 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Switch branch"
                      >
                        ...
                        <span className="truncate max-w-[100px]">{switchingBranch ? 'Switching...' : currentBranch}</span>
                        {!switchingBranch && (
          ...
          <div className="flex-1 flex flex-col bg-white dark:bg-[#0d0d0d] min-w-0">
            {/* 상단 토글 바 */}
            <div className="flex-shrink-0 bg-gray-100 dark:bg-[#1a1a1a] h-[73px] flex items-center justify-between px-4">
              <div className="flex items-center gap-3">
                ...
                {/* File path when file is selected */}
              ...
              {/* Route Navigation when preview is active */}
              {showPreview && previewUrl && (
                <div className="flex items-center gap-3">
                  <div className="h-8 flex items-center bg-gray-200 dark:bg-gray-800 rounded-lg px-3 border border-gray-300 dark:border-gray-600">
            ...
            {!showPreview ? (
              ...
              <>
                {/* File Tab */}
                <div className="flex-shrink-0 bg-gray-100 dark:bg-[#1a1a1a] h-[73px] flex items-center">
                  <div className="flex items-center">
                    <div className="flex items-center gap-2 bg-white dark:bg-[#0d0d0d] px-3 py-1.5 border-t-2 border-t-blue-500 dark:border-t-[#007acc] h-8">
              ...
              <AnimatePresence mode="wait">
                {previewUrl ? (
                  ...
                  <div className="h-full w-full flex items-center justify-center bg-gray-50 dark:bg-black relative">
                    {/* Same preview loading content as before */}
                      ...
                      {isStartingPreview ? (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-center gap-1 text-gray-600 dark:text-gray-400">
                            ...
                            <MotionDiv className="flex gap-1 ml-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                              <MotionDiv animate={{ opacity: [0, 1, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0 }} className="w-1 h-1 bg-gray-600 dark:bg-gray-400 rounded-full" />
                              <MotionDiv animate={{ opacity: [0, 1, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.3 }} className="w-1 h-1 bg-gray-600 dark:bg-gray-400 rounded-full" />
                              <MotionDiv animate={{ opacity: [0, 1, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.6 }} className="w-1 h-1 bg-gray-600 dark:bg-gray-400 rounded-full" />
                            </MotionDiv>
                          </div>
                        </MotionDiv>
                      ) : (
                        <div className="text-center">
                          <MotionDiv initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: "easeOut" }}>
                            {hasActiveRequests ? (
                              <>
                                <div className="w-40 h-40 mx-auto mb-6 relative">
                                  <MotionDiv
                                ...
                                >
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    {isStartingPreview ? (
                                      ...
                                      <MotionDiv className="flex items-center justify-center opacity-50">
      ...
      {showPreview && (
          <div className="absolute inset-0 z-30 bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
            ...
            <button
              onClick={() => setShowPreview(false)}
              className="absolute top-4 left-4 z-50 p-2 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
              title="Close Preview"
            >
